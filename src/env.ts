...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_API_PROXY_URL: z.string(),
    ...
    NEXT_PUBLIC_RESUME_BUILDER_URL: z.string(),
    NEXT_PUBLIC_CHROME_URL: z.string(),
    NEXT_PUBLIC_CHROME_TOKEN: z.string(),
  },
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_API_PROXY_URL: process.env.NEXT_PUBLIC_API_PROXY_URL,
    ...
    NEXT_PUBLIC_RESUME_BUILDER_URL: process.env.NEXT_PUBLIC_RESUME_BUILDER_URL,
    NEXT_PUBLIC_CHROME_URL: process.env.NEXT_PUBLIC_CHROME_URL,
    NEXT_PUBLIC_CHROME_TOKEN: process.env.NEXT_PUBLIC_CHROME_TOKEN,
  },
