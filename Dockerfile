...
ARG NEXT_PUBLIC_RESUME_BUILDER_URL
ARG NEXT_PUBLIC_CHROME_URL
ARG NEXT_PUBLIC_CHROME_TOKEN
...
ENV NEXT_PUBLIC_RESUME_BUILDER_URL=$NEXT_PUBLIC_RESUME_BUILDER_URL
ENV NEXT_PUBLIC_CHROME_URL=$NEXT_PUBLIC_CHROME_URL
ENV NEXT_PUBLIC_CHROME_TOKEN=$NEXT_PUBLIC_CHROME_TOKEN
